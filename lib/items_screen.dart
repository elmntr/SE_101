          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'Amount in Inventory'),
                keyboardType: TextInputType.number,
              ),
            ],
          ),
                      ...
                      child: Column(
                        ...
                        children: [
                          IconButton(
                            ...
                            icon: const Icon(Icons.add_circle, color: Colors.red, size: 60),
                          ),
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: DataTable(
                            ...
                            columns: const [
                              ...
                              DataColumn(label: Text('Set Price', style: TextStyle(fontWeight: FontWeight.bold))),
                              DataColumn(label: Text('Amount in Inventory', style: TextStyle(fontWeight: FontWeight.bold))),
