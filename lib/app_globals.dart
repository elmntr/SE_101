...
class AppGlobals {
  ...
  AppDatabase get database {
    if (_database == null) {
      throw StateError('Database not initialized. Call AppGlobals.initialize() first.');
    }
    return _database!;
  }
  ...
  SupabaseSyncService get syncService {
    if (_syncService == null) {
      throw StateError('SyncService not initialized. Call AppGlobals.initialize() first.');
    }
    return _syncService!;
  }
