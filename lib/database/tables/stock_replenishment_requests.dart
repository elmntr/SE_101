...
class StockReplenishmentRequests extends Table {
  ...
  TextColumn get status => text().withLength(min: 3, max: 50).withDefault(const Constant('pending'))();
  ...
  DateTimeColumn get requestedAt => dateTime().clientDefault(() => DateTime.now())();
